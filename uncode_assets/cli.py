...
用法::
    ...
    # 从游戏 .pkg 提取并解析
    python -m uncode_assets.cli info  D:/World_of_Warships_RU/Korabli
    ...
    python -m uncode_assets.cli extract D:/World_of_Warships_RU/Korabli --out ./assets.bin
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        ...
        epilog="""示例:
  python -m uncode_assets.cli info  D:/Korabli
