...
- `thickness_to_color(mm)`：厚度 → RGBA（游戏内装甲查看器配色）
...
# ────────────────────────────────────────────────────────────────────────────
# 装甲类型（归属）分类 —— 依据游戏内装甲类型定义整理
# ────────────────────────────────────────────────────────────────────────────
#: 材质前缀 → 装甲类型（与游戏内类型定义一致，顺序即 TYPE_ORDER）
