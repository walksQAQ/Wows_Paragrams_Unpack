...
class Mapping:
    MODIFIER_MAP = {
        ...
        "vulnerabilityDc": "受到的深水炸弹伤害",
        "vulnerabilityTorpedoAvia": "受到的舰载机鱼雷伤害",
        "vulnerabilityTorpedoShips": "受到的舰船鱼雷伤害",
        "vulnerabilityRocketAvia": "受到的火箭弹伤害",
        "vulnerabilityBombAvia": "受到的炸弹伤害",
    ...
    MODIFIER_FORMAT_MAP: dict[str, str] = {
        ...
        "vulnerabilityDc": "coeff",
        "vulnerabilityTorpedoAvia": "coeff",
        "vulnerabilityTorpedoShips": "coeff",
        "vulnerabilityRocketAvia": "coeff",
        "vulnerabilityBombAvia": "coeff",
    ...
    MODIFIER_COLOR_NEG: set[str] = {
        ...
        "vulnerabilityDc", "vulnerabilityTorpedoAvia", "vulnerabilityTorpedoShips",
        "vulnerabilityRocketAvia", "vulnerabilityBombAvia",
    ...
    # 舰长技能用勋带表：与 RIBBON_MAP 相同，仅 "13" 措辞不同（派生，避免双份维护）
    RIBBON_MAP_CREW = {**RIBBON_MAP, "13": "战斗机击落飞机"}
